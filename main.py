...
class Front:
    ...
    def login(self):
        ...
        self.menu_count = 0
        self.logo = PhotoImage(file='zeus_logo.png').subsample(3, 3)
        ...
        ttk.Label(self.frame_header, text='Welcome to Zeus Bank Banking!').grid(
            row=0, column=1, columnspan=2)

        self.frame_body = ttk.Frame(self.master)
        self.frame_body.pack()
        self.frame_body.config(relief=GROOVE, padding=(30, 15))
        ...
        self.user = ttk.Entry(self.frame_body, width=24, font=('Times New Roman', 10))
        self.psd = ttk.Entry(self.frame_body, width=24, font=('', 10))
        ...
        def temp_action():
            ...
            if self.log_name == self.vname and self.log_pass == self.vpass:
                messagebox.showinfo(
                    title='Welcome to Zeus Bank', message='Welcome {}'.format(self.log_name))
                self.home()
            else:
                messagebox.showerror(
                    title='Invalid', message='Please check User Name or Password entered')
    ...
    def forgot(self):
        ...
        self.frame_body.pack()
        self.frame_body.config(relief=GROOVE, padding=(30, 15))
        ttk.Label(self.frame_body, text='Type email address:').grid(
            row=0, column=1, padx=10, pady=10, sticky='sw')
        self.otpemail = ttk.Entry(
            self.frame_body, width=24, font=('Times New Roman', 10))
        ...
        def on_click_email():
            if self.obj.send_otp(self.otpemail.get()) == 1:
                ...
                messagebox.showerror(
                    title='Invalid', message='No account exists with the email entered')
    ...
    def home(self):
        ...
        ttk.Button(self.frame_body, text="Recent Transactions",
                   command=self.transaction_history).grid(row=2, padx=30, pady=10, column=1)
        ttk.Button(self.frame_body, text="Usage Graph",
        ...
        ttk.Label(self.frame_body, wraplength=300, text="Welcome to Zeus Bank. This is a simple, fast and elegant way of transferring money to anyone swiftly. Explore for more features.").grid(
    ...
    def create(self):
        ...
        self.repswd = ttk.Entry(self.frame_body, text="Re-type password: ")
        ...
        self.bankoptions = ['KCB', 'NCBA', 'Family Bank', 'Cooperstive Bank', 'Equity Bank', 'ABSA Bank']
    ...
    def temp_action2(self):
        ...
        if not pattern:
            ...
            if (self.obj.insert_record(self.vname, self.vemail, self.vdob, self.vphone, self.vaddress, self.vfirstpass, self.vupi, self.vbank, self.vacc)) == 1:
                ...
                messagebox.showinfo(
                    title='Welcome to Zeus Bank', message='Welcome {}'.format(self.vname))
                self.uid, self.vname, self.vemail, self.vaddress, self.vdob, self.vphone, self.vpass, self.vupi, self.vrecent, self.profile_photo, self.ouid, self.vbank, self.vacc, self.vbal = self.obj.get_details(
                    self.vname)
                self.profile_photo = self.obj.insert_blob(self.imgobj)
                self.home()
    ...
    def edit(self):
        ...
        button_explore = ttk.Button(self.frame_body,
                                    text="Change or Upload Profile Picture",
    ...
    def password_change(self):
        ttk.Label(self.frame_body, text='Type New password: ').grid(
    ...
    def psd_change(self):
        ...
        self.frame_body.pack()
        self.frame_body.config(relief=GROOVE, padding=(30, 15))
        ttk.Label(self.frame_body, text='Type Current password: ').grid(
    ...
    def edit_cancel2(self):
        value = messagebox.askyesno(
            title='Cancel The Changes?', message='Are you sure you want to cancel your the changes?')
        if value == True:
    ...
    def edit_cancel(self):
        ...
        value = messagebox.askyesno(
            title='Cancel Changes?', message='Are you sure you want to cancel the changes?')
    ...
    def transaction_history_friend(self, value):
        ...
        up_body.pack()
        up_body.config(relief=GROOVE, padding=(30, 15))
    ...
    def search(self):
        def pay_friend(value):
            ...
            self.frame_body.pack()
            self.frame_body.config(relief=GROOVE, padding=(30, 15))
            ttk.Label(self.frame_body, text="Enter Amount").grid(
                row=0, padx=10, pady=10, column=0)
            self.money_tran_friend = ttk.Entry(self.frame_body)
            self.money_tran_friend.grid(row=0, padx=10, pady=10, column=1)
            ttk.Button(self.frame_body, text='Pay', command=lambda: self.pay_tran_friend(
        ...
        self.search_var.set('Select search operation')
